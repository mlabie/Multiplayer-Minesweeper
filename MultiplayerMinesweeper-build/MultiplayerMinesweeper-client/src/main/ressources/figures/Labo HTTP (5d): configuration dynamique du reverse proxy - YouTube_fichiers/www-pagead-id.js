...
function rb(a,b){Xa(function(){O(kb().then(ob,function(a){return pb(b,a)}),x)},a)}
function qb(a){v("yt.ads.biscotti.lastId_",a)}
;w("yt.ads.biscotti.getId_")||v("yt.ads.biscotti.getId_",nb);var Z;try{var sb=w("yt.ads.biscotti.getId_");Z=sb?sb():nb()}catch(a){Z=N(a)}O(Z,x);}).call(this);
